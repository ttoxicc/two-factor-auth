...
# from database import save_user  # Убрана генерация кода
# import datetime

# BOT_TOKEN = '7425491173:AAG6AsJMxILCrOzPlK8z5pvAQtwNDMMPH9A'
...
#         # Сохраняем пользователя БЕЗ генерации кода
#         save_user(login, password, update.message.chat_id)
#         await update.message.reply_text("✅ Регистрация завершена! Теперь войдите на сайт.")
